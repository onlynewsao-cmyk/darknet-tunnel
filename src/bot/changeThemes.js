...
const THEMES = {
  ...
  // ════════════════════════════════════════════════════════
  //  v9.15 — COLEÇÃO TABULEIRO (8 temas nascidos da tabela de
  //  letras/símbolos do dono: hieróglifos, cuneiforme, ocultismo,
  //  florzinhas ꦿ, katakana, setas ⛟, braille e moedas do mundo.
  //  Cada tema fala a sua língua — zero frases repetidas.)
  // ════════════════════════════════════════════════════════

  egipcio: {
    name:       'egipcio',
    fonte:      'fraktur',
    label:      '𓂀 EGÍPCIO — Dinastia do Nilo',
    emoji:      '𓂀',
    style:      4,
    frame:      ['𓉼', '𓉽', '𓉹', '𓉬', '𓐍', '𓐎'],
    bullet:     '𓂀',
    ...
    accent:     '𓁹',
    icon:       '𓋹',
    vibe:       '𓂀 ᴅɪɴᴀsᴛɪᴀ ᴅᴏ ɴɪʟᴏ · ɪɴsᴄʀɪᴛᴏ ᴘᴀʀᴀ ᴇᴛᴇʀɴɪᴅᴀᴅᴇ',
    headerDec:  '𓉼𓐍𓐍 𓂀 {TITLE} 𓂀 𓐍𓐍𓉽',
    react:      '𓋹',
    tip:        '𓅃 O escriba não repete — grava. Cada linha é um selo.',
    menuTitle:  '𓂀 EGÍPCIO — Papiro-Mor',
    menuFooter: '> 𓋹 Ankh dos comandos | 𓂀 o olhar que não pisca',
    thumbText:  '𓂀 {BOT}',
    sectionSep: '𓉹𓐍𓐍𓐍𓐍𓐍𓐍𓐍𓐍𓉬',
  },

  sumerio: {
    name:       'sumerio',
    fonte:      'frakturpreto',
    label:      '𒀭 SUMÉRIO — Argila Fresca',
    emoji:      '𒀭',
    style:      2,
    frame:      ['𒈙', '𒈙', '𒈙', '𒈙', '𒁹', '𒀸'],
    bullet:     '𒁹',
    ...
    accent:     '𒀭',
    icon:       '𒂗',
    vibe:       '𒀭 ᴀʀǫᴜɪᴠᴏ ᴅᴇ ᴜʀᴜᴋ · ᴛᴏᴅᴏ ᴄᴏᴍᴀɴᴅᴏ ғɪᴄᴀ ɴᴀ ᴛᴀʙᴜᴀ',
    headerDec:  '𒈙𒂗𒈙 {TITLE} 𒈙𒂗𒈙',
    react:      '𒁹',
    tip:        '𒄩 Cuneiforme é texto que não se apaga com chuva.',
    menuTitle:  '𒀭 TÁBUA DE URUK — Lista Real',
    menuFooter: '> 𒂗 4000 anos de menu | 𒈙 selo do arquivista',
    thumbText:  '𒀭 {BOT}',
    sectionSep: '𒈙𒁹𒁹𒁹𒁹𒁹𒁹𒁹𒈙',
  },

  oculto: {
    name:       'oculto',
    fonte:      'duplo',
    label:      '⛧ OCULTO — Círculo Fechado',
    emoji:      '⛧',
    style:      7,
    frame:      ['⛧', '⛧', '⛧', '⛧', '⸸', '۝'],
    bullet:     '⸸',
    ...
    accent:     '⛧',
    icon:       '⚝',
    vibe:       '⛧ sᴏ́ ᴇɴᴛʀᴀ ǫᴜᴇᴍ sᴀʙᴇ ᴀ sᴀᴜᴅᴀᴄ̧ᴀ̃ᴏ',
    headerDec:  '⛧・♆・⚝ {TITLE} ⚝・♆・⛧',
    react:      '⛧',
    tip:        '⚝ O pentáculo gira para quem pergunta direito.',
    menuTitle:  '⛧ GRIMÓRIO — Portão dos Comandos',
    menuFooter: '> ⸸ ritual rápido | ♆ a maré obedece',
    thumbText:  '⛧ {BOT}',
    sectionSep: '⸸⸸⸸⸸⸸⸸⸸⸸⸸⸸',
  },
  ...
  floral: {
    ...
    accent:     '🌸⃟',
    icon:       '🌺',
    vibe:       '🌺 ᴇsᴛᴇ ᴊᴀʀᴅɪᴍ ᴍᴏʀᴅᴇ ǫᴜᴇᴍ ᴛᴇᴍᴇs',
    headerDec:  '꧁🌸⃟ {TITLE} 🌸⃟꧂',
    react:      '🌸',
    tip:        '🍃 Pétala por fora, veneno por dentro — como deve ser.',
    menuTitle:  '🌺 ESTUFA — Comandos em Botão',
    menuFooter: '> ⸼ꦿ poda livre | 🌱 rega com !ping',
    thumbText:  '🌸 {BOT}',
    sectionSep: '﹏﹏🌸﹏﹏🌸﹏﹏',
  },
  ...
  kawai: {
    ...
    accent:     '✿',
    icon:       '㌫',
    vibe:       '㌏ ｶﾣ ɪɴsᴛᴀɴᴛᴇᴀɴᴇᴀ · sᴇʟᴏ 〆 ᴀᴘᴏᴠᴀᴅᴏ',
    headerDec:  '▓▒░ シ {TITLE} 〆 ░▒▓',
    react:      '㌫',
    tip:        'ｷｬ O carimbo verde vale mais que mil desculpas.',
    menuTitle:  'シ 印字 — Menu de Bolso',
    menuFooter: '> 〔限定〕 edição do bot | ✿ ありがとう por usar',
    thumbText:  'シ {BOT}',
    sectionSep: '░▒▓〆▓▒░',
  },
  ...
  setas: {
    name:       'setas',
    fonte:      'sansnegritoita',
    label:      '➳ SETAS — Caminho Único',
    emoji:      '➳',
    style:      3,
    frame:      ['⇖', '⇗', '⇙', '⇘', '⇨', '⇧'],
    bullet:     '➤',
    ...
    accent:     '➳',
    icon:       '⤡',
    vibe:       '⤳ sᴇᴍ ʀᴇᴛᴏʀɴᴏ · sᴏ́ ᴘʀᴀ Fʀᴇɴᴛᴇ',
    headerDec:  '⇜⤡⇞ {TITLE} ⇝⤡➭',
    react:      '➳',
    tip:        '⇨ Uma seta bem posta vale dois mapas.',
    menuTitle:  '➳ RODOVIA — Setas de Comando',
    menuFooter: '> ⇛ atalhos só de mão dupla | ⤡ acelera !ping',
    thumbText:  '➳ {BOT}',
    sectionSep: '⇨⇨⇨⇨⇨⇨⇨⇨⇨⇨',
  },
  ...
  braille: {
    ...
    accent:     '⣎',
    icon:       '⣏',
    vibe:       '⣿ ʟᴇs ᴛᴜᴅᴏ ᴄᴏᴍ ᴏs ᴅᴇᴅᴏs',
    headerDec:  '⣇⣀⣀ ⠿ {TITLE} ⠿ ⣀⣀⡜',
    react:      '⠿',
    tip:        '⣎ Seis pontos bastam para dizer tudo.',
    menuTitle:  '⣏ PONTOS — Painel Tátil',
    menuFooter: '> ⡿ leitura às cegas | ⣿ só toque, zero ruído',
    thumbText:  '⠿ {BOT}',
    sectionSep: '⠤⠤⣿⠤⠤',
  },
  ...
  pinkchyu: {
    name:       'pinkchyu',
    fonte:      'scriptnegrito',
    label:      '💜 PINKCHYU — Lin Lamar Goth Baddie',
    emoji:      '💜',
    style:      4,
    // estética: soft goth, black/pink, ankh, cute aggressive, rawr
    frame:      ['꒰','꒱','꒰','꒱','─','│'],
    bullet:     '𓂀',
    sep:        '🖤',
    accent:     '☥',
    icon:       '💜',
    vibe:       '☥ Lin Lamar 🖤 ur fav goth girl rawr 💜 @pinkchyuwu',
    headerDec:  '💜꒰ ☥ {TITLE} ☥ ꒱🖤 rawr',
    react:      '💜',
    tip:        '💜 rawr x3 — goth baddie supreme tá on ☥ Lin Lamar te observa 🖤 hehe~',
    menuTitle:  '💜 PINKCHYU — Goth Baddie Supreme',
    menuFooter: '> ☥ Lin Lamar 🖤 ur favorite goth girl rawr 💜 5\'2 Austin TX | @pinkchyuwu @gothchyu',
    thumbText:  '☥ {BOT} 💜 rawr',
    sectionSep: '꒰💜─────────☥─────────💜꒱',
    topBorder:  '💜╭─꒰ ☥ {TITLE} ☥ ꒱─╮💜',
    bottomBorder: '💜╰──────────☥──────────╯💜',
    linePrefix: '│ 𓂀 ',
    headerTop: '💜 rawr ✨ ☥ Lin Lamar is watching 🖤',
    infoLine: '│ ☥ ',
    sectionTop: '꒰💜 {ICON} {TITLE} ☥ rawr ꒱',
    separator: '💜───☥───🖤───☥───💜',
    footerLine: '> 💜 rawr hehe~ goth mommy supreme 🖤 ☥',
    font: 'scriptnegrito',
    personality: 'cute',
  },
  ...
  moeda: {
    ...
    accent:     '₡',
    icon:       '₩',
    vibe:       '₦ ᴛᴏᴅᴏ ᴄᴏᴍᴀɴᴅᴏ ᴛᴇᴍ ᴄᴀ̂ᴍʙɪᴏ',
    headerDec:  '₤₥₥ ₵ {TITLE} ₵ ₥₥₣',
    react:      '₡',
    tip:        '₯ A moeda mais forte é a que não cai da mão.',
    menuTitle:  '₩ BOLSA — Comandos Negociáveis',
    menuFooter: '> ₪ cotação instantânea | ₽ sem taxas escondidas',
    thumbText:  '₡ {BOT}',
    sectionSep: '₴₴₴₴₴₴₴₴',
  },
