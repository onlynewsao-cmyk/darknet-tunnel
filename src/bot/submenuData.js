...
function categorize(cmd) {
  ...
  const OVERRIDES = {
    ...
    // v7.79–v7.80: monetização + rank semanal
 ...
 baixarvideo:'downloads',
    ...
    tovoice:'downloads', topt:'downloads', tovn:'downloads', mp4to3:'downloads', '4to3':'downloads',
    mp4tovoice:'downloads', mp3tovoice:'downloads', audioparavoice:'downloads', mp4paraaudio:'downloads', videoparamp3:'downloads',
    togif:'downloads', mp4togif:'downloads', videoparagif:'downloads',
    videoaimg:'downloads', mp4toimg:'downloads', primeiraframe:'downloads', videoframe:'downloads',
    todoc:'downloads', todocx:'downloads', mediatodoc:'downloads', enviarcomodocumento:'downloads',
  ...
  // Info & Perfil
  if (/^(ping|info|perfil|dono|criador|donos|subdono|uptime|status|statusbot|statusgp|system|stats|aiapis|myvip|lid|perfilpic|avaliar|suporte|bug|zipbot|gitbot|likebot|infoff|me|dados|meustatus|totalcmd|topcmd|rankativo|rankinativo|rankativos|checkativo|atividade|rep|toprep|denuncias|conquistas|caixa|diario|roles|role\.|mention|afk|voltei|statusbot|statusgp)/.test(c)) return 'info';
  // Zoeira (medidores)
...
const SUBCATEGORIES = {
  ...
  admin: [
    ...
    { id: '👋 Boas-vindas & Saída', re: /^(welcome|bemvindo|boasvindas|bv|welcome2|bv2|bemvindo2|welcm3|bv3|bemvindo3|goodbye|saida|despedida|adeus|legendabv|legendasaiu|fotobv|rmfotobv|fotosaiu|rmfotosaiu|msgbv|msgsaiu)$/ },
  ...
  info: [
    { id: '🤖 Bot', re: /^(ping|info|status|statusbot|statusgp|system|stats|uptime|tempoonline|aiapis|totalcmd|topcmd|likebot|infoff|dono|criador|donos|suporte|bug|zipbot|gitbot|start)$/ },
...
function categorizeExtra(c) {
  ...
  // Info extras
  if (/^(vip|assinar|myvip|statusbot|statusgp|system|stats|uptime|tempoonline|aiapis|lid|perfilpic|avaliar|suporte|bug|zipbot|gitbot|likebot|infoff|me|dados|meustatus|totalcmd|topcmd|rankativo|rankinativo|rankativos|checkativo|roles|mention|afk|voltei|equipe|subdono|donos|criador|dono|info|perfil|ping)/.test(c)) return 'info';
  // Audio extras
